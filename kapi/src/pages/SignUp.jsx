...
const SignUp = () => {
  return (
    <div  className='text-white h-[100vh]  flex flex-col justify-center items-center bg-red-400 bg-cover' style={{ "backgroundImage": "url('../src/assets/pesa/bg2.jpg')" }}>
      ...
      <img className="border-slate-400 my-4 py-4" width={100} height={100} src="../src/assets/pesa/icon.png" alt="logo image" />
        ...
        <form action="">
          ...
          <button type='submit' className="flex justify-center items-center py-4 px-4 font-monserrat text-[18px] leading-none rounded-full bg-white text-red-400 w-full  my-6 mr-4 hover:bg-red-400 hover:text-white duration-300 transition-colors" >SignUp</button>
          <div className='text-center'>
            <span className='m-4'>Already have an account? 
            <a href="{Login} "className='text-red-400 hover:text-slate-200 '> Login.</a> </span>
          </div>
          {/* <Button label="Login" />
          <div>
